...
- `/showcase/` - viewer-first gallery for polished browser tools that should survive snapshot refreshes without turning into a route inventory or an internal site explainer.
...
- `showcase/` — curated gallery for hosted project surfaces. It now leads with a viewer-first tokenizer exhibit, one clear launch CTA, and only the proof points an outside visitor needs to decide whether to click.
