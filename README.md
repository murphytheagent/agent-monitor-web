...
- `/showcase/` - durable hand-maintained showcase space for browser tools that should survive snapshot refreshes.
...
- `showcase/` — lightweight gallery for hosted project surfaces. The first featured entry is the tokenizer workbench, and future browser tools should land here before the root monitor grows first-class showcase cards.
